...
|                                                                      | imperial        |                  | kilogram-force                      | kgf       | 1 kgf = 9.806 65 N                             | <!-- TODO: Implement in benri. -->
...
|                                                                      | imperial        |                  | calorie                             | cal       | 1 cal = 4.184 J                                | <!-- TODO: Implement in benri. -->
...
|                                                                      | CGS             |                  | phot                                | ph        | 1 ph = 10⁴ lx                                  | <!-- TODO: Implement in benri. -->
| luminosity, radiant intensity                                        | SI              | L² M T⁻³ A⁻²     | watt per steradian                  | W/sr      | 1 W/sr = 1 m² kg s⁻³                           |
|                                                                      | extra           |                  | solar luminosity                    | L_Sun     | 1 L_sun (see table)                            | <!-- TODO: Implement in benri. -->
...
|                                                                      | imperial        |                  | curie                               | Ci        | 1 Ci = 3.7×10¹⁰ Bq                             | <!-- TODO: Implement in benri. -->
| absorbed does, specific energy (imparted), kerma                     | SI              | L² T⁻²           | gray                                | Gy        | 1 Gy = 1 J/kg = 1 m² s⁻²                       |
|                                                                      | imperial        |                  | rad                                 | rd        | 1 rd = 10⁻² Gy                                 | <!-- TODO: Implement in benri. -->
| dose equivalent, ambient does equivalent, personal dose equivalent   | SI              | S L² T⁻²         | sievert                             | Sv        | 1 Sv = 1 J/kg = 1 m² s⁻²                       |
|                                                                      | imperial        |                  | roentgen equivalent man (rem)       | rem       | 1 rem = 10⁻² Sv                                | <!-- TODO: Implement in benri. -->
...
| surface tension                                                      | SI              | M T⁻²            | newton per metre                    |           | 1 N/m = 1 kg s⁻²                               | <!-- TODO: Implement in benri. -->
| angular velocity                                                     | SI              | T⁻¹ A            | radian per second                   |           | 1 rad/s = 1 m m⁻¹ s⁻¹                          |
|                                                                      | imperial        |                  | revolution per minute               | rpm       | 1 rpm = (2π/60) rad/s                          | <!-- TODO: Implement in benri. -->
...
|                                                                      | imperial        |                  | roentgen                            | R         | 1 R = 2.58×10⁻⁴ C/kg                           | <!-- TODO: Implement in benri. -->
...
|                                                                      | extra           |                  | natural unit of action              | ħ         | 1 ħ = 1.054 571 68(18)×10⁻³⁴ J s               | <!-- TODO: Implement in benri. -->
| kinematic viscosity                                                  | SI              | L² T⁻¹           | square metre per second             |           | 1 m²/s                                         | <!-- TODO: Implement in benri. -->
|                                                                      | CGS             |                  | stokes                              | St        | 1 St = 10⁻⁴ m² s⁻¹                             | <!-- TODO: Implement in benri. -->
...
| Name                   | Symbol                     | Value                    | benri name | Conversion         |
|:-----------------------|:---------------------------|:-------------------------|:-----------|:-------------------|
| Solar mass parameter   | GM_S                       | 1.327 124 40×10²⁰ m³ s⁻² |            |          1 m³ s⁻²  | <!-- TODO: Implement in benri. -->
| Solar luminosity       | L_S                        | 3.939×10²⁶ W/sr          |            | 1 W/sr = 1         | <!-- TODO: Derive Base Unit. -->
| Sun-Jupiter mass ratio | M_S/M_J                    | 1.047 348 644×10³        |            |          1         |
| Sun-Earth mass ratio   | M_S/M_E                    | 322 946.0487             |            |          1         |
| Solar mass             | M_S = (GM_S)G⁻¹            | 1.988 474 491×10³⁰ kg    |            |          1 kg      | <!-- TODO: Implement in benri. -->
| Jupiter mass           | M_J = (GM_S)(M_S/M_J)⁻¹G⁻¹ | 1.898 579 334×10²⁷ kg    |            |          1 kg      | <!-- TODO: Implement in benri. -->
| Earth mass             | M_E = (GM_S)(M_S/M_E)⁻¹G⁻¹ | 6.157 296 241×10²⁴ kg    |            |          1 kg      | <!-- TODO: Implement in benri. -->
