...
TEST(quantity, power_helpers)
{
    ...
    EXPECT_BENRI_EQ(decltype(1_metre * metre * metre), 125_metre * metre * metre,
                    cubic(5_metre));
    EXPECT_BENRI_EQ(decltype(1_metre * metre * metre * metre),
                    625_metre * metre * metre * metre, quartic(5_metre));
}

TEST(quantity, division_multiplication)
{
    EXPECT_BENRI_EQ(decltype(1_metre / second), 1_metre / second * 1_one,
                    2_metre / 2_second);
    EXPECT_BENRI_EQ(decltype(1_metre / second), 1_metre / second * 2_one,
                    2_metre / second);
