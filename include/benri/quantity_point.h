...
#pragma region casting
    ...
    friend constexpr auto simple_cast(const quantity_point<Unit, ValueType> &rhs) -> quantity_point<ResultUnit, ValueType>;
    template <class ResultUnit, class Unit, class ValueType>
    friend constexpr auto unit_cast(const quantity_point<Unit, ValueType> &rhs) -> quantity_point<ResultUnit, ValueType>;
    template <class ResultValueType, class Unit, class ValueType>
...
#pragma region rule of three
    ...
    //quantity_point every time.
    quantity_point() = delete;
    //copy constructor
...
template <class ResultUnit, class Unit, class ValueType>
constexpr auto simple_cast(const quantity_point<Unit, ValueType> &rhs) -> quantity_point<ResultUnit, ValueType>
{
    //type checking
...
//implementation.
template <class ResultUnit, class Unit, class ValueType>
constexpr auto unit_cast(const quantity_point<Unit, ValueType> &rhs) -> quantity_point<ResultUnit, ValueType>
{
    //type checking
    static_assert(is_unit_v<ResultUnit>, "lhs has to be a unit.");
    static_assert(std::is_same_v<typename ResultUnit::system, typename Unit::system>, "lhs and rhs have to be from the same unit system.");
