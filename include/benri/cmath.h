...
[[nodiscard]] constexpr inline auto pow(const quantity<baseUnit, ValueType> base) noexcept -> std::enable_if_t<impl::is_ratio_v<Exponent>, quantity<pow_unit<baseUnit, Exponent>, ValueType>>
{
