...
[[nodiscard]] constexpr inline auto max_impl(const quantity<Unit, ValueType> x,
...
[[nodiscard]] constexpr inline auto
    max_impl(const quantity_point<Unit, ValueType> x,
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto min_impl(const quantity<Unit, ValueType> x,
                                             const quantity<Unit, ValueType> y) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    min_impl(const quantity_point<Unit, ValueType> x,
             const quantity_point<Unit, ValueType> y) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = std::remove_cvref_t<decltype(std::min(x.value(), y.value()))>;
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto abs(const quantity<Unit, ValueType> val) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    abs(const quantity_point<Unit, ValueType> val) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = decltype(std::abs(val.value()));
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto fabs(const quantity<Unit, ValueType> val) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    fabs(const quantity_point<Unit, ValueType> val) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = decltype(std::fabs(val.value()));
...
[[nodiscard]] constexpr inline auto fmod(const quantity<xUnit, ValueType> x,
...
[[nodiscard]] constexpr inline auto fmod(ValueType                        x,
                                         const quantity<yUnit, ValueType> y) noexcept
...
template <class xUnit, class yUnit, class ValueType>
[[nodiscard]] constexpr inline auto remainder(const quantity<xUnit, ValueType> x,
                                              const quantity<yUnit, ValueType> y) noexcept
    -> quantity<xUnit, ValueType>
{
...
template <class yUnit, class ValueType>
[[nodiscard]] constexpr inline auto remainder(ValueType                        x,
                                              const quantity<yUnit, ValueType> y) noexcept
    -> quantity<one_unit, ValueType>
{
...
template <class xUnit, class yUnit, class ValueType>
[[nodiscard]] constexpr inline auto remquo(const quantity<xUnit, ValueType> x,
...
template <class yUnit, class ValueType>
[[nodiscard]] constexpr inline auto
    remquo(ValueType x, const quantity<yUnit, ValueType> y, int* quo) noexcept
    -> quantity<one_unit, ValueType>
{
...
[[nodiscard]] constexpr inline auto fma(const quantity<xUnit, ValueType> x,
                                        const quantity<yUnit, ValueType> y,
...
// the same unit.
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto fmax_impl(const quantity<Unit, ValueType> x,
                                              const quantity<Unit, ValueType> y) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    fmax_impl(const quantity_point<Unit, ValueType> x,
              const quantity_point<Unit, ValueType> y) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = std::remove_cvref_t<decltype(std::fmax(x.value(), y.value()))>;
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto fmin_impl(const quantity<Unit, ValueType> x,
                                              const quantity<Unit, ValueType> y) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    fmin_impl(const quantity_point<Unit, ValueType> x,
              const quantity_point<Unit, ValueType> y) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = std::remove_cvref_t<decltype(std::fmin(x.value(), y.value()))>;
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto fdim_impl(const quantity<Unit, ValueType> x,
                                              const quantity<Unit, ValueType> y) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    fdim_impl(const quantity_point<Unit, ValueType> x,
              const quantity_point<Unit, ValueType> y) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = std::remove_cvref_t<decltype(std::fdim(x.value(), y.value()))>;
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto exp(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto exp2(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto expm1(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto log(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto log10(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto log2(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto log1p(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
[[nodiscard]] constexpr inline auto pow(const quantity<baseUnit, ValueType> base) noexcept
...
[[nodiscard]] constexpr inline auto
    pow(const quantity<baseUnit, ValueType>     y,
...
[[nodiscard]] constexpr inline auto
    pow(ValueType y, const quantity<exponentUnit, ValueType> x) noexcept
    -> std::enable_if_t<
...
[[nodiscard]] constexpr inline auto pow(const quantity<baseUnit, ValueType> y,
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto sqrt(const quantity<Unit, ValueType> val) noexcept
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto cbrt(const quantity<Unit, ValueType> val) noexcept
...
// provided.
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto hypot_impl(const quantity<Unit, ValueType> x,
                                               const quantity<Unit, ValueType> y) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto sin(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto cos(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value
            || std::is_same<typename Unit::dimension, dimension::plane_angle_t>::value,
        quantity<one_unit, ValueType>>
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto tan(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value
            || std::is_same<typename Unit::dimension, dimension::plane_angle_t>::value,
        quantity<one_unit, ValueType>>
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto asin(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto acos(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<plane_angle_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto atan(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<plane_angle_unit, ValueType>>
{
...
[[nodiscard]] constexpr inline auto atan2(const quantity<yUnit, ValueType> y,
...
template <class xUnit, class ValueType>
[[nodiscard]] constexpr inline auto atan2(ValueType                        y,
                                          const quantity<xUnit, ValueType> x) noexcept
    -> std::enable_if_t<
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto sinh(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto cosh(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto tanh(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto asinh(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto acosh(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto atanh(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto erf(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto erfc(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto tgamma(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto lgamma(const quantity<Unit, ValueType> val) noexcept
    -> std::enable_if_t<
        std::is_same<typename Unit::dimension, dimension::dimensionless_t>::value,
        quantity<one_unit, ValueType>>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto ceil(const quantity<Unit, ValueType> val) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    ceil(const quantity_point<Unit, ValueType> val) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = decltype(std::ceil(val.value()));
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto floor(const quantity<Unit, ValueType> val) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    floor(const quantity_point<Unit, ValueType> val) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = decltype(std::floor(val.value()));
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto trunc(const quantity<Unit, ValueType> val) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    trunc(const quantity_point<Unit, ValueType> val) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = decltype(std::trunc(val.value()));
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    nearbyint(const quantity<Unit, ValueType> val) noexcept -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    nearbyint(const quantity_point<Unit, ValueType> val) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = decltype(std::nearbyint(val.value()));
...
// long/long long.
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto round(const quantity<Unit, ValueType> val) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    round(const quantity_point<Unit, ValueType> val) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = decltype(std::round(val.value()));
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto lround(const quantity<Unit, ValueType> val) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    lround(const quantity_point<Unit, ValueType> val) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = decltype(std::lround(val.value()));
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto llround(const quantity<Unit, ValueType> val) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    llround(const quantity_point<Unit, ValueType> val) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = decltype(std::llround(val.value()));
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto rint(const quantity<Unit, ValueType> val) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    rint(const quantity_point<Unit, ValueType> val) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = decltype(std::rint(val.value()));
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto lrint(const quantity<Unit, ValueType> val) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    lrint(const quantity_point<Unit, ValueType> val) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = decltype(std::lrint(val.value()));
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto llrint(const quantity<Unit, ValueType> val) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    llrint(const quantity_point<Unit, ValueType> val) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = decltype(std::llrint(val.value()));
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto frexp(const quantity<Unit, ValueType> arg,
                                          int* exp) noexcept -> quantity<Unit, ValueType>
{
    using ResultType = decltype(std::frexp(arg.value(), exp));
    return quantity<Unit, ResultType>{std::frexp(arg.value(), exp)};
}
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto frexp(const quantity_point<Unit, ValueType> arg,
                                          int* exp) noexcept
    -> quantity_point<Unit, ValueType>
{
    using ResultType = decltype(std::frexp(arg.value(), exp));
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto ldexp(const quantity<Unit, ValueType> x,
                                          int exp) noexcept -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto modf(const quantity<Unit, ValueType> x,
                                         ValueType*                      iptr) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto scalbn(const quantity<Unit, ValueType> x,
                                           int exp) noexcept -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto scalbln(const quantity<Unit, ValueType> x,
                                            long                            exp) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    nextafter_impl(const quantity<Unit, ValueType> x,
                   const quantity<Unit, ValueType> y) noexcept
    -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    nexttoward_impl(const quantity<Unit, ValueType> x,
                    const quantity<Unit, ValueType> y) noexcept
    -> quantity<Unit, ValueType>
{
    using ResultType =
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    copysign_impl(const quantity<Unit, ValueType> x,
                  const quantity<Unit, ValueType> y) noexcept -> quantity<Unit, ValueType>
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    fpclassify(const quantity<Unit, ValueType> val) noexcept -> int
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto isfinite(const quantity<Unit, ValueType> val) noexcept
    -> bool
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    isfinite(const quantity_point<Unit, ValueType> val) noexcept -> bool
{
    return std::isfinite(val.value());
}
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto isinf(const quantity<Unit, ValueType> val) noexcept
    -> bool
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    isinf(const quantity_point<Unit, ValueType> val) noexcept -> bool
{
    return std::isinf(val.value());
}
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto isnan(const quantity<Unit, ValueType> val) noexcept
    -> bool
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    isnan(const quantity_point<Unit, ValueType> val) noexcept -> bool
{
    return std::isnan(val.value());
}
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto isnormal(const quantity<Unit, ValueType> val) noexcept
    -> bool
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    isnormal(const quantity_point<Unit, ValueType> val) noexcept -> bool
{
    return std::isnormal(val.value());
}
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto signbit(const quantity<Unit, ValueType> val) noexcept
    -> bool
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    signbit(const quantity_point<Unit, ValueType> val) noexcept -> bool
{
    return std::signbit(val.value());
}
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    isgreater_impl(const quantity<Unit, ValueType> x,
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    isless_impl(const quantity<Unit, ValueType> x,
                const quantity<Unit, ValueType> y) noexcept -> bool
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    isless_impl(const quantity_point<Unit, ValueType> x,
                const quantity_point<Unit, ValueType> y) noexcept -> bool
{
    return std::isless(x.value(), y.value());
}
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    islessequal_impl(const quantity<Unit, ValueType> x,
                     const quantity<Unit, ValueType> y) noexcept -> bool
{
...
template <class Unit, class ValueType>
[[nodiscard]] constexpr inline auto
    isunordered_impl(const quantity<Unit, ValueType> x,
                     const quantity<Unit, ValueType> y) noexcept -> bool
{
