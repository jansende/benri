...
static_assert(type::detect_if<atom<std::ratio<3>>, is_atom>, "");
#pragma endregion
...
static_assert(!type::detect_if<atom<std::ratio<2>, std::ratio_multiply<std::ratio<2>, std::ratio<1, 2>>>, is_root>, "");
static_assert(!type::detect_if<atom<std::ratio<2>, std::ratio_multiply<std::ratio<16>, std::ratio<1, 2>>>, is_root>, "");
static_assert(type::detect_if<atom<std::ratio<2>, std::ratio_multiply<std::ratio<16>, std::ratio<1, 3>>>, is_root>, "");
...
{
    static_assert(type::detect_if<Atom, is_atom>, "runtime_expand_atom takes a value type and an atom, but your Atom is not an atom.");
    static_assert(type::detect_if<Atom, has_valid_type>, "runtime_expand_atom requires the ::type of your Atom to be std::ratio or have a constexpr ::value.");
