...
namespace meta
{
// Custom constexpr version of std::accumulate because the standard is not there
// yet. Copied from: https://en.cppreference.com/w/cpp/algorithm/accumulate
...
// Custom constexpr version of std::lexicographical_compare because we only get
// it in c++17 plus the standard has no constexpr version yet. Copied from:
// https://en.cppreference.com/w/cpp/algorithm/lexicographical_compare
template <class InputIt1, class InputIt2>
constexpr auto lexicographical_compare(InputIt1 first1, InputIt1 last1, InputIt2 first2,
                                       InputIt2 last2) -> bool
{
