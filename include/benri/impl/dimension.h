...
struct dim
{
    static_assert(type::detect_if<T, type::has_name>, "T has to have a ::name attribute.");
    static_assert(type::detect_if<decltype(T::name), type::is_static_string>, "T::name has to be a meta::static_string.");
