...
implement_unit(si, knot, dim::velocity_t, fix(impl::divide_lists_t<prefix::nautical_mile_t, prefix::hour_t>));
...
implement_unit(si, nautical_mile, dim::length_t, prefix::nautical_mile_t);
implement_unit(si, international_mile, dim::length_t, prefix::international_mile_t);
implement_unit(si, yard, dim::length_t, prefix::yard_t);
implement_unit(si, international_foot, dim::length_t, prefix::international_foot_t);
implement_unit(si, inch, dim::length_t, prefix::inch_t);
#pragma endregion
...
implement_unit(si, carat, dim::mass_t, fix(impl::multiply_lists_t<make_fraction_list<2>, make_power_list<-4>>));
implement_unit(si, pound, dim::mass_t, prefix::pound_t);
implement_unit(si, ounce, dim::mass_t, prefix::ounce_t);
#pragma endregion
...
implement_unit(si, barn, dim::area_t, make_power_list<-28>);
...
implement_unit(si, millimeter_of_mercury, dim::pressure_t, fix(make_fraction_list<133322, 1000>));
implement_unit(si, atmosphere, dim::pressure_t, make_fraction_list<101325>);
implement_unit(si, torr, dim::pressure_t, fix(make_fraction_list<101325, 760>));
#pragma endregion
...
//TODO: Check
implement_unit(si, jansky, dim::surface_tension_t, fix(impl::multiply_lists_t<impl::multiply_lists_t<prefix::yocto, prefix::centi>, prefix::one>));
#pragma endregion
