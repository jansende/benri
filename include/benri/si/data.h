...
implement_subunit(si, si, data, kibi, dim::dimensionless_t, prefix::kibi);
implement_subunit(si, si, data, mebi, dim::dimensionless_t, prefix::mebi);
implement_subunit(si, si, data, gibi, dim::dimensionless_t, prefix::gibi);
implement_subunit(si, si, data, tebi, dim::dimensionless_t, prefix::tebi);
implement_subunit(si, si, data, pebi, dim::dimensionless_t, prefix::pebi);
implement_subunit(si, si, data, exbi, dim::dimensionless_t, prefix::exbi);
implement_subunit(si, si, data, zebi, dim::dimensionless_t, prefix::zebi);
implement_subunit(si, si, data, yobi, dim::dimensionless_t, prefix::yobi);
#pragma endregion
} // namespace data
} // namespace si
} // namespace benri