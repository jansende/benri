...
implement_subunit(si, astronomic, lightsecond, dim::length_t, fix(multiply_lists<prefix::speed_of_light_t, prefix::second_t>));
implement_subunit(si, astronomic, lightminute, dim::length_t, fix(multiply_lists<prefix::speed_of_light_t, prefix::minute_t>));
implement_subunit(si, astronomic, lighthour, dim::length_t, fix(multiply_lists<prefix::speed_of_light_t, prefix::hour_t>));
implement_subunit(si, astronomic, lightday, dim::length_t, fix(multiply_lists<prefix::speed_of_light_t, prefix::day_t>));
implement_subunit(si, astronomic, lightyear, dim::length_t, fix(multiply_lists<prefix::speed_of_light_t, prefix::year_t>));
...
implement_subunit(si, astronomic, arcminute, dim::plane_angle_t, fix(multiply_lists<prefix::pi_t, make_fraction_list<1, 10800>>));
implement_subunit(si, astronomic, arcsecond, dim::plane_angle_t, fix(multiply_lists<prefix::pi_t, make_fraction_list<1, 648000>>));
#pragma endregion
...
//TODO: Check
implement_subunit(si, astronomic, jansky, dim::surface_tension_t, fix(multiply_lists<prefix::yocto_t, prefix::centi_t>));
#pragma endregion
} // namespace astronomic
