...
using pi_t = type::sorted_list<impl::pre<pi>>;
...
//Golden ratio.
using e_t = type::sorted_list<impl::pre<e>>;
struct phi
{
...
using phi_t = type::sorted_list<impl::pre<phi>>;
...
//Square root of two.
using gamma_t = type::sorted_list<impl::pre<gamma>>;
...
using root_two_symbol_t = type::sorted_list<impl::pre<std::ratio<2>, std::ratio<1, 2>>>;
using root_two_t = type::sorted_list<impl::pre<root_two>>;
#pragma endregion
...
using speed_of_light_t = type::sorted_list<impl::pre<speed_of_light>>;
...
using gravitational_constant_t = type::sorted_list<impl::pre<gravitational_constant>>;
//Planck constant in Joule seconds.
struct planck_constant
{
    static constexpr Precision value = 6.62607004081e-34;
};
using planck_constant_t = type::sorted_list<impl::pre<planck_constant>>;
...
using elementary_charge_t = type::sorted_list<impl::pre<elementary_charge>>;
...
using avogadro_constant_t = type::sorted_list<impl::pre<avogadro_constant>>;
...
using molar_gas_constant_t = type::sorted_list<impl::pre<molar_gas_constant>>;
...
using atomic_mass_unit_t = type::sorted_list<impl::pre<atomic_mass_unit>>;
...
using sidereal_year_t = type::sorted_list<impl::pre<sidereal_year>>;
//Tropical year in seconds.
struct tropical_year
{
    static constexpr Precision value = 3.155693e7;
};
using tropical_year_t = type::sorted_list<impl::pre<tropical_year>>;
#pragma endregion
...
using astronomical_unit_t = type::sorted_list<impl::pre<astronomical_unit>>;
//Parsec in metre.
