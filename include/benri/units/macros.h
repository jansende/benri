...
#define implement_unit(SYSTEM, NAMESPACE, NAME, DIMENSIONS, PREFIX)                  \
    using NAME##_t = unit<SYSTEM, sort_list<DIMENSIONS>, sort_list<PREFIX>>;                               \
...
#define create_symbol(SYSTEM, NAME, DIMENSIONS, PREFIX) \
    constexpr auto NAME = quantity<unit<SYSTEM, sort_list<DIMENSIONS>, sort_list<PREFIX>>>{static_cast<Precision>(1)};
