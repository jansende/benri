...
#pragma region casting
    ...
    friend constexpr inline auto simple_cast(const quantity<ArgumentUnit, ArgumentValueType> &rhs) noexcept -> std::enable_if_t<std::is_same<typename ResultUnit::dimension, typename ArgumentUnit::dimension>::value && type::detect_if<ResultUnit, type::is_unit>, quantity<ResultUnit, ArgumentValueType>>;
    template <class ResultUnit, class ArgumentUnit, class ArgumentValueType>
    friend constexpr inline auto unit_cast(const quantity<ArgumentUnit, ArgumentValueType> &rhs) noexcept -> std::enable_if_t<std::is_same<typename ResultUnit::dimension, typename ArgumentUnit::dimension>::value && type::detect_if<ResultUnit, type::is_unit>, quantity<ResultUnit, ArgumentValueType>>;
    template <class ResultValueType, class ArgumentUnit, class ArgumentValueType>
    friend constexpr inline auto remove_prefix(const quantity<ArgumentUnit, ArgumentValueType> &rhs) noexcept -> quantity<drop_unit_prefix<ArgumentUnit>, ResultValueType>;
#pragma endregion
#pragma region rule of three
    ...
    template <class Dummy = void, typename = std::enable_if_t<type::detect_if<unit_type, type::is_one>, Dummy>>
    ...
    template <class Dummy = value_type, typename = std::enable_if_t<type::detect_if<unit_type, type::is_one>, Dummy>>
...
template <class ResultUnit, class ArgumentUnit, class ArgumentValueType>
[[nodiscard]] constexpr inline auto simple_cast(const quantity<ArgumentUnit, ArgumentValueType> &rhs) noexcept -> std::enable_if_t<std::is_same<typename ResultUnit::dimension, typename ArgumentUnit::dimension>::value && type::detect_if<ResultUnit, type::is_unit>, quantity<ResultUnit, ArgumentValueType>>
{
...
//implementation.
template <class ResultUnit, class ArgumentUnit, class ArgumentValueType>
[[nodiscard]] constexpr inline auto unit_cast(const quantity<ArgumentUnit, ArgumentValueType> &rhs) noexcept -> std::enable_if_t<std::is_same<typename ResultUnit::dimension, typename ArgumentUnit::dimension>::value && type::detect_if<ResultUnit, type::is_unit>, quantity<ResultUnit, ArgumentValueType>>
{
...
template <class ResultValueType, class ArgumentUnit, class ArgumentValueType>
[[nodiscard]] constexpr inline auto remove_prefix(const quantity<ArgumentUnit, ArgumentValueType> &rhs) noexcept -> quantity<drop_unit_prefix<ArgumentUnit>, ResultValueType>
{
    using PrefixType = typename ArgumentUnit::prefix;
    const auto factor = runtime_expand_prefix_list<ResultValueType>(PrefixType{});
    return quantity<drop_unit_prefix<ArgumentUnit>, ResultValueType>{static_cast<ResultValueType>(rhs._value) * factor};
}
